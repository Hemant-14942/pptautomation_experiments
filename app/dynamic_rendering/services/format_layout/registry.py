...
SLIDE_FORMATTERS: dict[str, object] = {
    ...
    SLIDE_TYPE_QPILL_ONLY: format_qpill_only_slide,
...
def format_slide(slide: Slide, slide_type: str, prs: Presentation | None = None, dspec=None) -> bool:
    ...
    if formatter is None:
        return False
    return bool(formatter(slide, prs, dspec))