...
def format_title_body_only_slide(slide: Slide, prs: Presentation | None = None, dspec=None) -> bool:
    ...
    replace_shape(sp_tree, shapes["body_el"], format_body_only(shapes["body_el"], dspec))
    return True
