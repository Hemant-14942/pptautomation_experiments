...
def format_title_image_only_slide(slide: Slide, prs: Presentation | None = None, dspec=None) -> bool:
    ...
    clones = format_images(shapes["picture_els"], shapes["image_sizes"], dspec=dspec)
