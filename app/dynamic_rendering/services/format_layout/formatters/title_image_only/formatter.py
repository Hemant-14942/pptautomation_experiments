"""Clone content pictures into fixed slots below the heading."""

from lxml import etree

from app.dynamic_rendering.services.format_layout.formatters.title_image_only.constants import (
    get_title_image_boxes,
)
