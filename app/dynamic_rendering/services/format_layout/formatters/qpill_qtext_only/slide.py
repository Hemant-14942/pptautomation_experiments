...
def format_qpill_qtext_only_slide(slide: Slide, prs: Presentation | None = None, dspec=None) -> bool:
    ...
    replace_shape(sp_tree, shapes["question_label_el"], format_question_label(shapes["question_label_el"], dspec=dspec))
    replace_shape(sp_tree, shapes["question_text_el"], format_question_text(shapes["question_text_el"], dspec))
    return True
